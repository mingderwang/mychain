...
import (
	...
	"github.com/foo/mychain/x/mychain"
	mychainkeeper "github.com/foo/mychain/x/mychain/keeper"
	mychaintypes "github.com/foo/mychain/x/mychain/types"
  // this line is used by starport scaffolding # 1
)

const appName = "mychain"

var (
	DefaultCLIHome = os.ExpandEnv("$HOME/.mychaincli")
	DefaultNodeHome = os.ExpandEnv("$HOME/.mychaind")
...
func NewInitApp(
  ...
  // this line is used by starport scaffolding # 4
	...
	app.mm = module.NewManager(
		...
		mychain.NewAppModule(app.mychainKeeper, app.bankKeeper),
